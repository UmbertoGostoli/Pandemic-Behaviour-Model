...
class Person:
    ...
    def __init__ (self, mother, father, birthYear, age, sex, house, sec, cr, pcr, wage, 
        ...
        self.casesTimesEncounters = 0
        self.contagiousnessFactor = 0
        self.casesByAge = []
...
class HypotheticalVisit:
    def __init__ (self, agent, venue, weight):
        self.visitor = agent
        self.venue = venue
        self.weight = weight
