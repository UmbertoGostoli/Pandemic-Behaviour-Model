...
class Venue:
    counter = 1
    """Contains a collection of venues."""
    def __init__ (self, town):
        self.town = town
        self.x = -1
        self.y = -1
        self.occupants = []
        self.numVirtualOccupants = 0
        self.attendantsByAgeClass = [[0]*5]*9
        self.pastAttendants = []
        self.pastAttendance = 0
        self.sizeCat = -1
        self.id = Venue.counter
        Venue.counter += 1
